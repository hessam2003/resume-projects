...
router.get('/', async (req, res) => {
  try {
    ...
    // Render the 'Resources3399' page, passing data to it
    res.render('Resources3435', {
      activeTab: 'Resources3435',
      nonce: nonce,
      showNegoNoMercy: false // Ustawienie wartości na false, ponieważ NegoNoMercy nie powinno być widoczne w tym pliku
    });
  } catch (error) {
    // Handle any errors, e.g., by rendering an error page
    res.render('error', { errorMessage: 'An error occurred while fetching resources.' });
  }
});
